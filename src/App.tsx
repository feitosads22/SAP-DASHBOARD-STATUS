...
<div className="brand-mark">SAP</div>
  ...
  <main>
    ...
    {module === "schedule" && <Cronograma projects={projects} />}
    ...
    {module === "financial" && <Financeiro projects={projects} />}

    {module === "resources" && <Recursos projects={projects} />}
    ...
    {module === "governance" && <Governanca projects={projects} />}
  </main>
  ...
  <section className="panel">
    <div className="panel-head">
      <div>
        <h3>Projetos</h3>
        <p>
          Selecione um projeto para abrir a visão executiva detalhada.
        </p>
      </div>
...
<p>{project.name}</p>
    ...
    <section className="executive-section">
      ...
      <div className="health-drivers">
        ...
        <Driver
          ...
          value={openIssues}
          tone={openIssues > 0 ? "attention" : "healthy"}
        />
    ...
    <section className="executive-section">
      ...
      <div className="placeholder-card">
        ...
        <div>
          <strong>Indicadores de cronograma</strong>
          <span>
            Dados detalhados conectados ao módulo de
            cronograma.
          </span>
        </div>
    ...
    <section className="executive-section">
      ...
      <div className="milestone-empty">
        ...
        <strong>
          Marcos disponíveis no módulo Cronograma
        </strong>

        <span>
          Cadastre os marcos para acompanhar datas
...
return (
<div
className={executive-metric ${ highlight ? "highlight" : "" }}
>
<span>{label}</span>
<strong>{value}</strong>
</div>
